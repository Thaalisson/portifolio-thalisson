...
const jobs = [
  {
    ...
    achievements: {
      en: [
        ...
        "Architected and maintained .NET Core backend services and REST APIs with Clean Architecture, SOLID principles, and dependency injection — improved issue resolution time by 15%",
        "Implemented caching strategies and query optimization that reduced average API response time by 20%",
        "Built reporting and analytics features (data aggregation pipelines, export modules) that increased decision-making speed by 25%",
        "Drove cross-functional collaboration between backend, mobile, and product teams — reduced overall rework by 30%",
      ],
      pt: [
        ...
        "Arquitetou e manteve serviços backend .NET Core e REST APIs com Clean Architecture, SOLID e injeção de dependência — melhorou tempo de resolução em 15%",
        "Implementou estratégias de cache e otimização de queries que reduziram tempo médio de resposta da API em 20%",
        "Criou features de relatórios e analytics (pipelines de agregação, módulos de exportação) que aumentaram velocidade de decisão em 25%",
        "Liderou colaboração cross-funcional entre backend, mobile e produto — reduziu retrabalho em 30%",
      ],
    },
